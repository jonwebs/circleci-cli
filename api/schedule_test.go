...
func TestSchedules(t *testing.T) {
	mockFn := func(r *http.Request) (*http.Response, error) {
		if r.URL.String() != "https://circleci.com/api/v2/github/test-org/test-project/schedule" {
...
func TestScheduleByID(t *testing.T) {
	...
	t.Run("Get a schedule by ID", func(t *testing.T) {
		testSchedule := mockSchedule()
		schedule, err := restClient.ScheduleByID(testSchedule.ID)
		assert.NilError(t, err)
		assert.DeepEqual(t, testSchedule, *schedule)
	})
}
...
func TestScheduleByName(t *testing.T) {
	...
	t.Run("Get a schedule by name", func(t *testing.T) {
		testSchedule := mockSchedule()
		schedule, err := restClient.ScheduleByName("github", "test-org", "test-project", testSchedule.Name)
		assert.NilError(t, err)
		assert.DeepEqual(t, testSchedule, *schedule)
	})
}
...
func TestCreateSchedule(t *testing.T) {
	...
	t.Run("Create a schedule", func(t *testing.T) {
		schedule := mockSchedule()
		err := restClient.CreateSchedule("github", "test-org", "test-project",
...
func TestUpdateSchedule(t *testing.T) {
	...
	t.Run("Update a schedule", func(t *testing.T) {
		schedule := mockSchedule()
		err := restClient.UpdateSchedule(schedule.ID, schedule.Name, schedule.Description,
